 ...
 * @author haunert
 */
public class OwnMap extends Map implements MouseListener, MouseMotionListener {
	...
	/**
	 * If true, the OwnMap content is automatically scaled to fit this display frame
	 * when its size is changed.
	 */
	private boolean autoFitToDisplay;

	/**
	 * If frameRation {@literal >} 0, a margin is left between the OwnMap and the frame
	 * of the display.
	 */
	private double frameRatio;

	/**
	 * The Layers of Symbols that are displayed in this OwnMap.
	 */
	private TreeMap<Integer, Layer> layers;

	/**
	 * The transformation that is used to transform OwnMap coordinates to image
	 * coordinates.
	 */
	...
	/**
	 * The minimum x coordinate of the OwnMap.
	 */
	private double xMin;

	/**
	 * The minimum y coordinate of the OwnMap.
	 */
	private double yMin;

	/**
	 * The maximum x coordinate of the OwnMap.
	 */
	private double xMax;

	/**
	 * The maximum y coordinate of the OwnMap.
	 */
	private double yMax;
	 ...
	 */
	private OwnMapPanel myMapFrame;

	/**
	 * This constructor generates a new empty MapDisplay.
	 * @param m OwnMap panel
	 */

	public OwnMap(OwnMapPanel m) {
		super(m);
		myMapFrame = m;
	...
	/**
	 * Defines whether the OwnMap content is automatically scaled to fit this display
	 * frame when its size is changed.
	 * 
	 * @param b if true the OwnMap content is automatically scaled
	 */
	...
	/**
	 * Adds a new layer to this OwnMap.
	 * 
	 * @param l: the layer
	 ...
	 *                         are drawn first.
	 * @param fitMapToDisplay: whether OwnMap shall be fit to display
	 */
	...
	/**
	 * Redefines the transformation that transforms OwnMap coordinates to image
	 * coordinates.
	 * 
	...
	/**
	 * Returns the transformation that transforms OwnMap coordinates to image
	 * coordinates.
	 * 
	...
	/**
	 * Defines the margin between the OwnMap and the frame of this OwnMap display.
	 * 
	...
	/**
	 * Fits the OwnMap to this MapDisplay.
	 */
	...
	/**
	 * Fits a part of the OwnMap to the current extent of the display, specified by the
	...
	public Transformation getMyTransformation() {
		return myTransformation;
	}
